...
return {
  {
    ...
    b = controls('gp1:B', 'gp1:Y', 'rgui'),
    a = controls('gp1:A', 'gp1:X', 'ralt'),
  },
  {
    ...
    b = controls('gp2:B', 'gp2:Y', 'a'),
    a = controls('gp2:A', 'gp2:X', 'q'),
  },
  {
    ...
    b = controls('gp3:B', 'gp3:Y', ';'),
    a = controls('gp3:A', 'gp3:X', 'p'),
  },
  {
    ...
    b = controls('gp4:B', 'gp4:Y'),
    a = controls('gp4:A', 'gp4:X'),
  }
}
